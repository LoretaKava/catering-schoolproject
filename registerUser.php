...
include('db.php');
 ...
 if($_POST['action']=="registerUser"){
    $user_data = "SELECT * FROM users WHERE  email = '".$_POST['inputEmailAddress']."'";
		...
		$insert_user2="insert into users(full_name,email,password,phone) VALUE 
        ('".$_POST['inputFullName']."','".$_POST['inputEmailAddress']."','".$_POST['inputPassword']."','".$_POST['inputPhoneNumber']."')";
    ...
    //  update
    $update_user="update users set full_name='".$_POST['inputFullName']."',email='".$_POST['inputEmailAddress']."',password='".$_POST['inputPassword']."',phone='".$_POST['inputPhoneNumber']."' where id='".$_POST['id']."'";
