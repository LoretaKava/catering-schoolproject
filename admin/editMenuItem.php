...
if (isset($_POST['update'])) {
    ...
    if (!empty($_FILES["fileToUpload"]["name"])) {
       ...
       echo $updateQuery = "UPDATE menu_items SET `name` = '" . $_POST['inputProductName'] . "',
        `description` = '" . $_POST['inputDescription'] . "',`price` = " . $_POST['inputPrice'] . "
        , `image` = '$file_name', category_id = '" . $_POST['inputCategory'] . "' WHERE `id` = " . $_GET['id'] . "";
        ...
        $updateQuery = "UPDATE menu_items SET `name` = '" . $_POST['inputProductName'] . "', `description` = '" . $_POST['inputDescription'] . "',`price` = '" . $_POST['inputPrice'] . "', category_id = '" . $_POST['inputCategory'] . "' WHERE `id` = '" . $_GET['id'] . "'";
        if (mysqli_query($db, $updateQuery)) {
                        ...
                        <div class="card mb-4">
                            ...
                            <div class="card-body">
                                <form action="<?php $_SERVER['PHP_SELF']; ?>" method="POST" autocomplete="off" enctype="multipart/form-data">
                                    ...
                                    $sql = "SELECT * from menu_items  where id='" . $_GET['id'] . "' ";
                                    ...
                                    ?>
                                            ...
                                            <div class="row gx-3 mb-3">
                                               <div class="col-md-6">
                                                    <label class="small mb-1" for="Image">Category</label>
                                                    <select required class="form-control" name="inputCategory">
                                                        ...
                                                        ?>
                                                                <option value="<?php echo $row2['id']; ?>" <?php if ($row1['category_id'] == $row2['id']) {
                                                                                                                echo "selected";
                                                                                                            } ?>>
